...
puts "PRACTICES PAGE"
@content = Content.create_with(heading: "Class Schedule", :index => 1, :display_content_on_page => true, :display_content_fields => false, :page_id => Page.named("Classes").id).find_or_create_by(heading: "Class Schedule")
puts @content.inspect
now = DateTime.now
@practice = Practice.create_with(day_of_week: "Sunday", day_of_week_index: 1, start_time: Time.parse("06:30").in_time_zone('Central Time (US & Canada)'), end_time: Time.parse("07:45").in_time_zone('Central Time (US & Canada)'), cost_per_month: "30", content_id: @content.id).find_or_create_by(day_of_week: "Sunday")
puts @practice.inspect
@ractice = Practice.create_with(day_of_week: "Friday", day_of_week_index: 6, start_time: Time.parse("20:30").in_time_zone('Central Time (US & Canada)'), end_time: Time.parse("21:45").in_time_zone('Central Time (US & Canada)'), cost_per_month: "30", content_id: @content.id).find_or_create_by(day_of_week: "Friday")
puts @practice.inspect
puts ""
puts ""
...
@content = Content.create_with(heading: "Equipment", :index => 1, :display_content_on_page => true, :display_content_fields => true, :page_id => @resources_page_id).find_or_create_by(heading: "Equipment")
puts @content.inspect
@link = Link.create_with(name: "E-Bogu", :link => "https://www.e-bogu.com/", :index => 1, :content_id => @content.id).find_or_create_by(name: "E-Bogu")
puts @link.inspect
...
@link = Link.create_with(name: "Tozando", :link => "https://www.tozandoshop.com/", :index => 2, :content_id => @content.id).find_or_create_by(name: "Tozando")
puts @link.inspect
...
@link = Link.create_with(name: "Maruyama", :link => "https://maruyamakendosupply.com/", :index => 3, :content_id => @content.id).find_or_create_by(name: "Maruyama")
puts @link.inspect
...
@link = Link.create_with(name: "Kendo Star", :link => "https://kendostar.com/", :index => 4, :content_id => @content.id).find_or_create_by(name: "Kendo Star")
puts @link.inspect
...
puts ""
puts "FEDERATIONS"
@content = Content.create_with(heading: "Federations", :index => 2, :display_content_on_page => true, :display_content_fields => true, :page_id => @resources_page_id).find_or_create_by(heading: "Federations")
puts @content.inspect
@link = Link.create_with(name: "Midwest Kendo Federation (MWKF)", :link => "https://midwestkendofederation.wordpress.com/", :index => 1, :content_id => @content.id).find_or_create_by(name: "Midwest Kendo Federation (MWKF)")
puts @link.inspect
...
@link = Link.create_with(name: "All United States Kendo Federation (AUSKF)", :link => "http://www.auskf.info/index.htm", :index => 2, :content_id => @content.id).find_or_create_by(name: "All United States Kendo Federation (AUSKF)")
puts @link.inspect
...
puts "KATA"
@content = Content.create_with(:heading => "Kata 7", :description => "A very interesting article about kata number 7.", :index => 3, :display_content_on_page => true, :display_content_fields => true, :page_id => @resources_page_id).find_or_create_by(heading: "Kata 2")
puts @content.inspect
