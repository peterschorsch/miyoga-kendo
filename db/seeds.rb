...
puts "PRACTICES PAGE"
@content = Content.create_with(heading: "Class Schedule", :index => 1, :display_content_on_page => true, :display_content_fields => false, :page_id => Page.named("Classes").id, :user_id => User.admin_accounts.first.id).find_or_create_by(heading: "Class Schedule")
puts @content.inspect
now = DateTime.now
...
@content = Content.create_with(heading: "Equipment", :index => 1, :display_content_on_page => true, :display_content_fields => true, :page_id => @resources_page_id, :user_id => User.admin_accounts.second.id).find_or_create_by(heading: "Equipment")
puts @content.inspect
...
puts ""
puts "FEDERATIONS"
@content = Content.create_with(heading: "Federations", :index => 2, :display_content_on_page => true, :display_content_fields => true, :page_id => @resources_page_id, :user_id => User.admin_accounts.third.id).find_or_create_by(heading: "Federations")
puts @content.inspect
...
puts "KATA"
@content = Content.create_with(:heading => "Kata 7", :description => "A very interesting article about kata number 7.", :index => 3, :display_content_on_page => true, :display_content_fields => true, :page_id => @resources_page_id, :user_id => User.admin_accounts.first.id,).find_or_create_by(heading: "Kata 2")
puts @content.inspect
...
puts ""
puts "TIE HAKAMA"
@content = Content.create_with(:heading => "How to tie your Hakama", :description => "Checkout this article on how to tie your hakama.", :index => 4, :display_content_on_page => true, :display_content_fields => true, :page_id => @resources_page_id, :user_id => User.admin_accounts.second.id).find_or_create_by(heading: "How to tie your Hakama")
puts @content.inspect
