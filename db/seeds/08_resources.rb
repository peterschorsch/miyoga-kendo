...
@content = Content.create_with(heading: "Equipment", :index => 1, :archived => false, :article => false, :page_id => @resources_page_id, :user_id => User.admin_accounts.second.id).find_or_create_by(heading: "Equipment")
...
puts "----------FEDERATIONS----------"
@content = Content.create_with(heading: "Federations", :index => 2, :archived => false, :article => false, :page_id => @resources_page_id, :user_id => User.admin_accounts.third.id).find_or_create_by(heading: "Federations")
puts @content.inspect
...
puts "----------KATA----------"
@content = Content.create_with(:heading => "Kata 7", :description => "A very interesting article about kata number 7.", :index => 1, :archived => false, :article => true, :page_id => @resources_page_id, :user_id => User.admin_accounts.first.id).find_or_create_by(heading: "Kata 7")
puts @content.inspect
...
puts "----------TIE HAKAMA----------"
@content = Content.create_with(:heading => "How to tie your Hakama", :description => "Checkout this article on how to tie your hakama.", :index => 2, :archived => false, :article => true, :page_id => @resources_page_id, :user_id => User.admin_accounts.second.id).find_or_create_by(heading: "How to tie your Hakama")
puts @content.inspect
