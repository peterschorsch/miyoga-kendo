...
class Admin::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post admin_users_url, params: { admin_user: { active: @admin_user.active, email: @admin_user.email, firstname: @admin_user.firstname, lastname: @admin_user.lastname } }
    end
  ...
  test "should update admin_user" do
    patch admin_user_url(@admin_user), params: { admin_user: { active: @admin_user.active, email: @admin_user.email, firstname: @admin_user.firstname, lastname: @admin_user.lastname } }
